...
namespace Common
{
    public class Logger
    {
        ...
        private const string Exception = "{0}";
        ...
        public static void Write(LogLevel level, string textmail, bool sendmail, string msg, params object[] args)
        {
            if ((int) LogLevel < (int) level || LogLevel == LogLevel.Off)
                return;
        ...
        public static void LogEnter(string method)
        {
            Write(LogLevel.Trace, null, false, MethodEnter, method);
        }

        public static void LogLeave(string method)
        {
            Write(LogLevel.Trace, null, false, MethodLeaveVoid, method);
        }

        public static T LogLeave<T>(string method, T ret)
        {
            Write(LogLevel.Trace, null, false, MethodLeave, method, ret);
            return ret;
        }

        public static void LogException(string method, Exception e, bool sendmail, string textmail)
        {
            Write(LogLevel.Error, textmail, sendmail, Exception, method + " " + e);
        }

        public static void LogException(string method, Exception e, bool sendmail)
        {
            LogException(method, e, sendmail, null);
        }

        public static void LogException(string method, Exception e)
        {
            LogException(method, e, false, null);
        }

        public static void LogWebException(string method, WebException e, bool sendmail, string textmail)
        {
            Write(LogLevel.Error, textmail, sendmail, ExceptionWeb, method + " " + e);
        }

        public static void LogWebException(string method, WebException e, bool sendmail)
        {
            LogWebException(method, e, sendmail, null);
        }

        public static void LogWebException(string method, WebException e)
        {
            LogWebException(method, e, false, null);
        }

        public static void LogError(string method, string s, bool sendmail, string textmail)
        {
            Write(LogLevel.Error, textmail, sendmail, Exception,
                method + (string.IsNullOrEmpty(method) ? string.Empty : " ") + s);
        }

        public static void LogError(string method, string s, bool sendmail)
        {
            LogError(method, s, sendmail, null);
        }

        public static void LogError(string method, string s)
        {
            LogError(method, s, false, null);
        }

        public static void LogError(string s)
        {
            LogError(string.Empty, s, false, null);
        }

        public static void LogTrace(string method, string s, bool sendmail, string textmail)
        {
            Write(LogLevel.Trace, textmail, sendmail, MethodTrace, method + " " + s);
        }

        public static void LogTrace(string method, string s, bool sendmail)
        {
            LogTrace(method, s, sendmail, null);
        }

        public static void LogTrace(string method, string s)
        {
            LogTrace(method, s, false, null);
        }
        ...
        private void CheckWriter()
        {
            ...
            try
            {
                string fname = LogPrefix
                               + DateTime.Now.Date.ToString(@"\-yyyy\-MM\-dd")
                               + ".txt";

                _writer = new StreamWriter(Path.Combine(LogDir,
                        fname),
                    true,
